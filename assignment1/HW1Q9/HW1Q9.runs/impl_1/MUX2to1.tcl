...
set rc [catch {
  ...
  add_files -quiet C:/Users/12217/Documents/GitHub/1920SemB_EE4204_RayC/assignment1/HW1Q9/HW1Q9.runs/synth_1/MUX2to1.dcp
  ...
  link_design -top MUX2to1 -part xc7z020clg400-1
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force MUX2to1_physopt.dcp
